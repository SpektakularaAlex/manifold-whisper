...
interface Props {
  ...
  onMissionResult?: (result: unknown, builderLegs: BuilderLeg[]) => void;
  embedded?: boolean;
}
...
export function MissionPanel({
  ...
  async function flyMission() {
    ...
    try {
      ...
      onMissionResult?.(data, builderLegs);
    } catch (err) {
  ...
  //   //     top: embedded ? undefined : 380,
  //   //     left: embedded ? undefined : 20,
  //   //     zIndex: embedded ? undefined : 20,
  //   //     width: embedded ? "100%" : 360,
  //   //     maxHeight: embedded ? 360 : "calc(100vh - 420px)",
  //   //     overflowY: "auto",
  //   //     padding: embedded ? "8px 0 0" : "14px 16px",
  //   //     background: embedded ? "transparent" : "rgba(0, 8, 14, 0.92)",
  //   //     border: embedded ? 0 : "1px solid rgba(0,255,255,0.3)",
  //   //     backdropFilter: embedded ? undefined : "blur(10px)",
  //   //     boxShadow: embedded ? "none" : "0 0 12px rgba(0,255,255,0.15)",
  //   //     color: "#e0eeff",
  //   //     fontFamily: "'Space Mono', monospace",
  //   //     fontSize: 12,
  //   //   }}
