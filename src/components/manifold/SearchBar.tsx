...
export function SearchBar({ onSelectSystem, onSelectFamily, onShowConcept }: SearchBarProps) {
  ...
  function handleSelect(entry: SearchEntry) {
    ...
    else if (entry.type === "family" && entry.systemId && entry.familyId)
      onSelectFamily(entry.systemId, entry.familyId);
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 12px rgba(0,255,255,0.10)",
        }}
      >
        <Search size={14} style={{ color: "rgba(0,255,255,0.4)", flexShrink: 0 }} />
        <input
          ref={inputRef}
          className="manifold-search-input"
          type="text"
          value={query}
          ...
          {results.map((entry, i) => (
            <button
              ...
              style={{
                ...
                width: "100%",
                padding: "8px 12px",
                background: highlighted === i ? "rgba(0,255,255,0.08)" : "transparent",
                border: "none",
                borderBottom: i < results.length - 1 ? "1px solid rgba(0,255,255,0.1)" : "none",
                cursor: "pointer",
                textAlign: "left",
              }}
            >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 2 }}>
                  ...
                  <span
                    style={{
                      ...
                      border: `1px solid ${TYPE_COLOR[entry.type]}`,
                      padding: "1px 4px",
                      opacity: 0.8,
                    }}
                  >
